  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        <MainTitle text="blocKit Component Documentation" id="underlined"/>
        <br id="styles"/>
        <br />
        <ul>
          <li>
          ...
          <li>
            <MainTitle text="Root Color Scheme:"/>
            <Subtitle text="Light Mode" id="underlined" />
            <code>{`
            ...
            <Subtitle text="Dark Mode" id="underlined" />
            <code>{`
            ...
            <Subtitle text="Fonts" id="underlined" />
            <code>
              {`{ Anton, Goldman, Iceland } from "next/font/google";`}
            </code>
          </li>
          <li>
            <MainTitle text="Container Element Styling: " />
            <Subtitle text="html, body" id="underlined" />
            <code>{`
              max-width: 100vw;`}<br />{`
              scroll-behavior: smooth; `}
            </code>
            <Subtitle text="body" id="underlined" />
            <code>{`
            ...
            <Subtitle text="all (*)" id="underlined" />
            <code>{`
        ...
        <br />
        <ul>
          <li><Subtitle text='Components' /></li>
          <li>
          ...
          <li>
            <MainTitle text="Hyperlink" />
            <Description text="Provides a wrapper for any children and/or text recieved via the 'text' prop. Extends the <a> class." />
            <div className="codeSection">
              <pre><code>
                {`Example Usage: \n\n`}
